...
console.log(_logging.NewRelicLoggingService, "---NewRelicLoggingService");
...
var DatadogLoggingService = /*#__PURE__*/function (_NewRelicLoggingServi) {
  function DatadogLoggingService(options) {
    var _this;
    _classCallCheck(this, DatadogLoggingService);
    _this = _callSuper(this, DatadogLoggingService, [options]);
    var config = options ? options.config : undefined;
    _this.ignoredErrorRegexes = config ? config.IGNORED_ERROR_REGEX : undefined;
    _this.initialize();
    return _this;
  }
  ...
  _inherits(DatadogLoggingService, _NewRelicLoggingServi);
  return _createClass(DatadogLoggingService, [{
    ...
    value: function logInfo(infoStringOrErrorObject) {
      ...
      _get(_getPrototypeOf(DatadogLoggingService.prototype), "logInfo", this).call(this, infoStringOrErrorObject, customAttributes);
    ...
    value: function logError(errorStringOrObject) {
      var customAttributes = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      _get(_getPrototypeOf(DatadogLoggingService.prototype), "logError", this).call(this, errorStringOrObject, customAttributes);
    ...
    value: function setCustomAttribute(name, value) {
      _get(_getPrototypeOf(DatadogLoggingService.prototype), "setCustomAttribute", this).call(this, name, value);
      if (name === 'userId') {
...
}(_logging.NewRelicLoggingService);
